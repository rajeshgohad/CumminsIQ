...
import CycleTimeAgentModal from '../components/cycle/CycleTimeAgentModal'

interface Props { apiKey: string }

export default function CycleTimeAgentPage({ apiKey }: Props) {
        ...
        <div className="grid grid-cols-3 gap-4 flex-1 min-h-0">
          <div className="card rounded-xl p-4">
            <BottleneckDetail
              ...
              apiKey={apiKey}
              onInvestigate={() => setModalOpen(true)}
            />
          </div>
          <div className="card rounded-xl p-4">
